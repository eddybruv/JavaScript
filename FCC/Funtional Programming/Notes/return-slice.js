...
// the second is the index for where to end the slice (and it's non-inclusive). If the 
// arguments are not provided, the default is to start at the beginning of the array 
// through the end, which is an easy way to make a copy of the entire array. 
